                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select id="status_artikel" name="status_artikel" class="form-control">
                            <option {{ $post->status_artikel == 'Drafted' ? 'selected' : '' }}>Drafted</option>
                            <option {{ $post->status_artikel == 'Published' ? 'selected' : '' }}>Published</option>
                            <option {{ $post->status_artikel == 'Featured' ? 'selected' : '' }}>Featured</option>
                        </select>
                    </div>
                    <div class="form-group">
