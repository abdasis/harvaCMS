    ...
    <div class="container-fluid">
        <div class="row mb-5">
            <div class="col-lg-4">
                <div class="pr-lg-4">
                    <div class="mb-4">
                    <h3 class="text-white-50">Arah Indonesia</h3>
                    </div>

                    <p class="text-white-50">Arah indonesia adalah Portal Berita Paling yang Menyajikan informasi menarik dan teraktual</p>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="float-left pull-none">
                    <p class="text-white-50">2015 - {{ date('Y') }} © Arah Indonesia. Design by <a href="https://harvasoft.com/" target="_blank" class="text-white-50">Harvasoft</a> </p>
                </div>
